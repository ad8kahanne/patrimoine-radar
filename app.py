...
if gdf_brut is not None:
    ...
    if not gdf_final.empty:
        ...
        # Le secret : on ignore les retours de mouvement pour ne pas déclencher de boucle
        output = st_folium(m, width=None, height=500, key="map_stable")
        
        # On ne met à jour le centre QUE si on clique sur un résultat dans le tableau
        st.markdown("---")
